...
This is an interactive diagram with hyperlinks that presents an end-to-end sales analytics solution for a UK retail company dataset. It showcases everything from data sourcing and cleaning to analysis and dashboarding, all version-controlled and documented.
